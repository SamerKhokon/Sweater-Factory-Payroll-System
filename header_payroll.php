...
<div class="grid_12">
	...
	$sql="select * from PAYROLL_MENU where MAIN_MENU_ID in(".$payroll_user_main_menu.")";							
    ...
    while(($row = mysqli_fetch_array($stid))) 
    {
		...
		$sql_sub="select * from PAYROLL_SUB_MENU1 where PAYROLL_SUB_MENU_ID=$main_menu_id  and PAYROLL_SUB_MENU_ID in (".$payroll_user_sub_menu.")";			
		...
		{  
			...
			$PAYROLL_SUB_MENU_ID=$row_sub["PAYROLL_SUB_MENU_ID"];
			
			echo "<li><a href=\"?pagetitle=$sub_menu_content&menu_id=$main_menu_id&sm_id=$PAYROLL_SUB_MENU_ID\">$sub_menu_name</a></li>";  		 
		}
		echo "</ul></li>";
    }
    ?>
