...
<div class="grid_12">
    ...
    while(($row = oci_fetch_array($stid, OCI_BOTH))) 
    {
		...
		$menu_id		=$row["MAIN_MUNU_ID"]; 	
		
		
		echo "<li class='ic-dashboard'><a href='?pagetitle=$menu_content&menu_id=$menu_id'>$menu_name</a><ul>";  
		
		$main_menu_id=$row['MAIN_MUNU_ID'];
		$sql_sub="select * from PAYROLL_SUB_MENU1 where PAYROLL_SUB_MENU_ID=$main_menu_id  and PAYROLL_SUB_MENU_ID in (".$payroll_user_sub_manu.")";			
