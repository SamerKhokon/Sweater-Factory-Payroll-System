...
$str	='Fixed Emp Extra OT Payslip';
...
<table border="0" cellpadding="0" cellspacing="0" align="center"  class="details" style="font-family:solaimanlipi, Arial, Helvetica, sans-serif;"> 
	<tbody><tr>
        	<td colspan="3" align="left" class="colh" style="border-left:1px solid #000000; border-top:1px solid #000000;">Card ID	/<img src="bangla_img/id.png" height="15px;"> :&nbsp;'. $card_id.'<br />Name/<img src="bangla_img/nam.png" height="15px;">	:&nbsp;'.$name.'<br>Grade/<img src="bangla_img/grade.png" height="14px;">:&nbsp;'.$grade.'</td>
			
			
			<td colspan="4">Section/<img src="bangla_img/division.png" height="18px;">
	:&nbsp;'.getSectionName($section_id).'<br>Line:'.getBlockName($block_id,$section_id).'<br />Desig/<img src="bangla_img/designation1.png" height="15px;">:&nbsp;'.$designation.'</td>
			...
			<td>Med&nbsp;:'.$medical_view.'<br><img src="bangla_img/medical.png" height="14px;">:&nbsp;'.$app->get_unicode_bn_num($medical_view).'</td>
			
			<td>Gross&nbsp;:'.$actual_salary_view.'<br><img src="bangla_img/total.png" height="14px;">:&nbsp;'.$app->get_unicode_bn_num($actual_salary_view).'</td>
			
        </tr>
		<tr>
            <td colspan="5">Attendance Information<br>T.W.D&nbsp;'.$total_w_day.'/<img src="bangla_img/total_day.png">-'.$app->get_unicode_bn_num(make_comma($total_w_day)).'</td>
			...
			<td rowspan="2" colspan="2">Signature<br><img src="bangla_img/signature.png"></td>
...
<?php
	...
	a.SECTION_ID='$section_id' and a.STATUS='1' and b.EXTRA_OT>0  ".$xsql."  and to_char(b.MONTH_YEAR,'mm/yyyy') between '$month_year1' and '$month_year2'  
