...
<table border="0" cellpadding="0" cellspacing="0" align="center"  class="details" style="width:100%;font-family:solaimanlipi;"> 
	<tbody><tr>
	...
	:&nbsp;'.getSectionName($section_id).'<br>Line:'.getBlockName($block_id,$section_id).'<br />Desig/<img src="bangla_img/designation1.png" height="15px;">:&nbsp;'.$designation.'</td>
			...
			<td colspan="2">Med&nbsp;:'.$medical_view.'<br><img src="bangla_img/medical.png" height="14px;">:&nbsp;'.$app->get_unicode_bn_num($medical_view).'<br>Food&nbsp;:'.$food_amnt.'</td>
...
<?php
	...
	a.SECTION_ID='$section_id' and a.STATUS='1' and a.CARD_ID='$card_id'  ".$xsql."  and to_char(b.MONTH_YEAR,'mm/yyyy') between '$month_year1' and '$month_year2'  
	...
	b.WORKS_DAY,b.TOTAL_ATTEND,b.LEAVE,b.LATE_PRESENT,b.LUNCH_OUT,b.OT,b.HOLY_DAY,b.ADVANCE ,a.GROSS,a.HOUSE_RENT,a.MEDICAL,b.CASUAL,b.SICK,b.GOVT_HOLI,a.BLOCK_ID,(select TO_DATE('".$dateidT."', 'MM/DD/YY')-(select TO_DATE(to_char(JOIN_DATE,'MM/DD/YY'),'MM/DD/YY') from TBL_PAY_EMP_PROFILE where ID=a.ID) FROM dual) as day_diff,cast(substr(a.CARD_ID,2,9) as number) as pp  
