...
<?php
	$str	='Fixed Salary Extra OT Reports';
...
//to_char(b.MONTH_YEAR,'mm/yyyy')='$month_year'	
	...
	a.SECTION_ID='$section_id' and a.COMPANY_ID=$company_id and a.STATUS='1' and b.EXTRA_OT>0  and to_char(b.MONTH_YEAR,'mm/yyyy') between '$month_year1' and '$month_year2' ".$xsql."   
	order by pp";
 ...
 <tr style="font-weight:bold;">
 	<td colspan="4">Total Employee:<?php echo $j; ?></td><td colspan="3"></td><td><?php //echo make_comma($actual_salary_total); ?></td><td colspan="7"></td><td><?php  echo make_comma($ot_total); ?></td><td></td><td><?php echo make_comma($ot_amnt_total); ?></td><td><?php echo make_comma($ot_amnt_total); ?></td><td></td>
 </tr>
 <tr style="font-weight:bold;">
