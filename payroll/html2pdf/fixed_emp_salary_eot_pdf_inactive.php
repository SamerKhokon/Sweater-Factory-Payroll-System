...
<?php
	$str	='Fixed Salary Extra OT Reports(Inactive)';
	//echo tbl_header_fun1($dateid,$dateidT,$str);
?>
<br />
<table width="100%" style="width:100%;font-family:solaimanlipi;"><tr><td style="width:230px;">&nbsp;</td><td><?php echo tbl_header_fun1($dateid,$dateidT,$str); ?></td><td align="right">&nbsp;</td></tr></table>
...
//to_char(b.MONTH_YEAR,'mm/yyyy')='$month_year'	
	...
	a.SECTION_ID='$section_id' and a.COMPANY_ID=$company_id and a.STATUS!='1'  and to_char(b.MONTH_YEAR,'mm/yyyy') between '$month_year1' and '$month_year2' order by pp";
 ...
 <tr style="font-weight:bold;">
 	<td colspan="5">Total Employee:<?php echo $j; ?></td><td colspan="3"></td><td><?php //echo make_comma($actual_salary_total); ?></td><td colspan="7"></td><td><?php  echo make_comma($ot_total); ?></td><td></td><td><?php echo make_comma($ot_amnt_total); ?></td><td><?php echo make_comma($ot_amount); ?></td><td></td>
 </tr>
 <tr style="font-weight:bold;">
 	<td colspan="21" align="left"><?php
...
try
{
	$html2pdf = new HTML2PDF('L', 'A4', 'fr',array(5, 10, 0,0));
