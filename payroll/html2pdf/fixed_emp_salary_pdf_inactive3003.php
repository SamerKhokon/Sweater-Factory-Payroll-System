...
//to_char(b.MONTH_YEAR,'mm/yyyy')='$month_year'
	...
	b.WORKS_DAY,b.TOTAL_ATTEND,b.LEAVE,b.LATE_PRESENT,b.LUNCH_OUT,b.OT,b.HOLY_DAY,b.ADVANCE ,a.GROSS,a.HOUSE_RENT,a.MEDICAL,b.CASUAL,b.SICK,a.BLOCK_ID,a.GRADE,b.GOVT_HOLI,b.EXTRA_OT,b.OTHER_AMNT,(select TO_DATE('".$dateidT."', 'MM/DD/YY')-(select TO_DATE(to_char(JOIN_DATE,'MM/DD/YY'),'MM/DD/YY') from TBL_PAY_EMP_PROFILE where ID=a.ID) FROM dual) as day_diff,a.SECTION_ID,cast(substr(a.CARD_ID,2,9) as number) as pp
	...
	
	{
				...
				*/
				...
				$actual_gross_amnt	=round($basic_gain+$fest_v+$actual_ot_amnt+$atn_bon+$other_amnt);
