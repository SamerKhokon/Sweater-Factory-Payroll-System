...
<table border="0" cellpadding="0" cellspacing="0" align="center"  class="details"> 
    <thead>
    	...
    	<tr>
        	<th colspan="10"><b>Section:<?php echo  getSectionName($section_id); ?></b></th><th colspan="11"></th><th colspan="6"><b>Line:<?php echo getBlockName($block_id,$section_id); ?></b></th><th colspan="3">Page Number:&nbsp;[[page_cu]]/[[page_nb]]</th>
        </tr>
...
//to_char(b.MONTH_YEAR,'mm/yyyy')='$month_year'	
 ...
 <tr style="font-weight:bold;">
 	<td colspan="4">Total Employee:<?php echo $j; ?></td><td colspan="3"></td><td><?php //echo make_comma($actual_salary_total); ?></td><td colspan="8"></td><td><?php echo make_comma(round($abs_amnt_total)); ?></td><td><?php echo make_comma($leave_amnt_total); ?></td><td><?php echo make_comma($atn_bon_total); ?></td><td><?php //echo make_comma($govt_holi_total); ?></td><td><?php echo make_comma($govt_holi_amnt_total); ?></td><td><?php  echo make_comma($ot_total); ?></td><td></td><td><?php echo make_comma($ot_amnt_total); ?></td><td><?php echo $other_amnt_all; ?></td><td><?php echo make_comma($gross_amnt_total); ?></td><td><?php echo make_comma($advance_total); ?></td><td><?php echo make_comma($stamp_total); ?></td><td><?php echo make_comma($net_pay_total); ?></td><td>&nbsp;</td>
 </tr>
 <tr style="font-weight:bold;">
