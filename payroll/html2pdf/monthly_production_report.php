...
<?php
$str	='Monthly Production Reports';
?>
<table width="100%">
<tr><td style="width:120px;">&nbsp;</td><td><?php echo tbl_header_fun1($dateid,$dateto,$str); ?></td><td align="left"></td>
</tr>
<tr>
	<td style="width:120px;">&nbsp;</td><td align="center"><br />Section:&nbsp;<?php echo  getSectionName($section_id); ?></td><td align="left"></td>
</tr>
</table>
<br/>
...
<?php
	...
	$sql ="select DISTINCT CARD_ID,(select NAME from TBL_PAY_EMP_PROFILE where CARD_ID=a.CARD_ID and COMPANY_ID=$company_id and SECTION_ID=$section_id) as NAME,cast(substr(a.CARD_ID,2,9) as number) as pp from TBL_PAY_EMP_PRODUCTION a where a.COMPANY_ID=$company_id and a.SECTION_ID=$section_id ".$xsql." ".$xsqlb."  and to_date(to_char(pro_date,'mm/dd/YYYY') ,'mm/dd/YYYY')between to_date('$dateid','mm/dd/YYYY') and to_date('$dateto','mm/dd/YYYY') order by pp";		
