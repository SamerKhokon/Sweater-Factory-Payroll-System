...
<table border="0" cellpadding="0" cellspacing="0" align="center"  class="details" style="font-family:solaimanlipi, Arial, Helvetica, sans-serif;"> 
	<tbody><tr>
		...
		<tr>
            ...
            <td rowspan="2">OT<br>Hr<br><img src="bangla_img/ot.png"></td>
...
$where	=" where 1=1 and a.company_id='$company_id' and 
	a.CARD_ID=b.CARD_ID  and a.SECTION_ID=b.SECTION_ID and b.SECTION_ID=c.ID and a.STATUS!='1' and c.SEC_TYPE_ID=52 and b.TOTAL_ATTEND is not null and to_char(b.MONTH_YEAR,'mm/yyyy') between '$month_year1' and '$month_year2' order by pp";
...

{
			...
			*/
			...
			$produc_chk			=round(($produc_amnt['production_amnt']+$produc_bonus));
