...
<table border="0" cellpadding="0" cellspacing="0" align="center"  class="details" style="font-family:solaimanlipi, Arial, Helvetica, sans-serif;"> 
	<tbody><tr>
			...
			<td colspan="2">H Rent&nbsp;:'.$h_rent_view.'<br><img src="bangla_img/house_rent1.png" height="15px;">:&nbsp;'.$app->get_unicode_bn_num($h_rent_view).'<br>Con amt&nbsp;:'.$amount_cv.'</td>
		...
		<tr>
			<td colspan="18" align="left">'.convert_number($net_pay).'</td>
		</tr>
 </tbody></table>............................................................................................................................................................................................................................................................................................................................................................';
}
?>
...
and b.TOTAL_ATTEND!=0
*/

$where	=" where 1=1 and a.company_id='$company_id' and 
	a.CARD_ID=b.CARD_ID  and a.SECTION_ID=b.SECTION_ID and b.SECTION_ID=c.ID and a.STATUS!='1' and c.SEC_TYPE_ID=52  and to_char(b.MONTH_YEAR,'mm/yyyy') between '$month_year1' and '$month_year2' order by pp";


$sql	="select 

a.CARD_ID,a.NAME,a.BASIC,a.GRADE,a.DESIGNATION,
b.WORKS_DAY,b.TOTAL_ATTEND,b.LEAVE,b.LATE_PRESENT,b.LUNCH_OUT,b.OT,b.HOLY_DAY,b.ADVANCE,a.GROSS,a.HOUSE_RENT,a.MEDICAL,b.CASUAL,b.SICK,a.BLOCK_ID,b.GOVT_HOLI,b.EXTRA_OT,b.OTHER_AMNT,a.SECTION_ID as SECTION_ID,cast(substr(a.CARD_ID,2,9) as number) as pp     
...

{
			...
			$produc_amnt_ck=(int)round($produc_amnt['production_amnt']);
		
			$produc_bonus		=round(fn_production_bonus($produc_amnt['production_amnt'],$section_id));
			
			/*$produc_chk			=round(($produc_amnt['production_amnt']+$produc_bonus+$fest_v+$ot_amount+$atn_bon+$leave_amnt+$govt_holi_amnt+$other_amnt+$food_amnt+$amount_cv));
			*/
			...
			if($produc_chk<$basic_gain)
				$total_v	=round($basic_gain+$food_amnt+$amount_cv);
			else
			...
			*/	
			...
			{			
					...
					echo productionEmp_paysleep($card_id,$name,$grade,$designation,$basic_view,$h_rent_view,$medical_veiw,$actual_salary_view,$total_w_day,$atten,$leave,$late_pre,$lunch_out,$abs_days,$basic_gain,$atn_bon_view,$holiday,$holi_amnt_view,$ot,$ot_rate,$ot_amount,$total_amnt_view,$fest_v_view,$advance_view,$produc_amntT,$produc_bonus,$total_v,$net_pay_view,$dateidT,$dateidT,$str,$section_id,$net_pay,$stamp,$leave_amnt,$casual_l,$sick_l,$total_amnt,$block_id,$gov_holiday,$govt_holi_amnt,$other_amnt,$food_amnt,$amount_cv);
			}
...
try
{
	$html2pdf = new HTML2PDF('P', 'L', 'en',true,'UTF-8',array(0, 0, 0,0));
