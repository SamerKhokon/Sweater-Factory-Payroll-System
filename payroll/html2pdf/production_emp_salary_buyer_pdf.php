...
<table border="0" cellpadding="0" cellspacing="0" align="center"  class="details"> 
    <thead>
    	<tr>
        	<th colspan="9"><b>Section:<?php echo  getSectionName($section_id) ?></b></th><th colspan="10"></th><th colspan="6"><b>Line:<?php echo getBlockName($block_id,$section_id); ?></b></th><th colspan="4">Page Number:&nbsp;[[page_cu]]/[[page_nb]]</th>
        </tr>
        <tr>
	...
	while($row = oci_fetch_array($qstr, OCI_BOTH+OCI_RETURN_NULLS))
	{
		...
		<tr>	
            ...
            <!--  <td><?php echo $total_amnt_view; ?></td>
              ...
              <td><?php //echo round($basic_gain).'-'.round($produc_chk2).'-'.round($produc_chk).'-'.$basic_gain2.'-'.$total_v2; ?></td>
