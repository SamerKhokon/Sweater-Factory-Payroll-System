...
<table border="0" cellpadding="0" cellspacing="0" align="center"  class="details"> 
    <thead>
    	<tr>
        	<th colspan="9"><b>Section:<?php echo  getSectionName($section_id) ?></b></th><th colspan="13"></th><th colspan="5"><b>Line:<?php echo getBlockName($block_id,$section_id); ?></b></th><th colspan="4">Page Number:&nbsp;[[page_cu]]/[[page_nb]]</th>
        </tr>
        <tr>
            ...
            <th rowspan="2">Lev<br />Amt</th>
           <!-- <th rowspan="2">Basic<br />Gain</th>-->
            
            <th rowspan="2">No<br />Work<br />Amt</th>
...
//to_char(b.MONTH_YEAR,'mm/yyyy')='$month_year'	
	...
	a.SECTION_ID='$section_id' and a.STATUS='1' and to_date(to_char(b.MONTH_YEAR,'mm/yyyy'),'mm/YYYY') between to_date('$month_year1','mm/YYYY') and to_date('$month_year2','mm/YYYY') ".$xsql."   
	order by pp";
	...
	while($row = oci_fetch_array($qstr, OCI_BOTH+OCI_RETURN_NULLS))
	{
				...
				*/	
				...
				$nowork_amnt_total	+=$no_work_amnt;
				$no_work_amnt_view	=make_comma($no_work_amnt);	
				...
				$produc_chk			=($produc_amnt['production_amnt']+$produc_bonus+$fest_v+$ot_amount+$atn_bon+$leave_amnt+$govt_holi_amnt+$other_amnt+$no_work_amnt);
				...
				if($produc_chk2<$basic_gain)
				{
					...
					{
						//$total_v		=round($basic_gain)+$produc_bonus+$actual_ot_amnt+$atn_bon+$other_amnt;
		...
		<tr>	
             ...
             <!-- <td><?php echo $holiday; ?></td>-->
              ...
              <td><?php echo $no_work_amnt_view; ?></td>
          ...
          <td><?php echo $net_pay_view; ?></td>
              <td><?php //echo round($basic_gain).'-'.round($produc_chk2).'-'.round($produc_chk).'-'.$basic_gain2.'-'.$vt.'-'.$total_v2; ?></td>
		</tr>
		<?php		
		...
		if($row = oci_fetch_array($qstr, OCI_BOTH+OCI_RETURN_NULLS))
		{
			if($block_id2!='')
			{
				...
				$dateid,$leave_amnt_total,$govt_holi_amnt_total,$total_v_all,$other_amnt_all,$nowork_amnt_total);
			}
		}	
	 	else
		{
 ...
 <tr style="font-weight:bold;">
 	<td colspan="4">Total Employee:<?php echo $j; ?></td><td colspan="5"></td><td><?php //echo make_comma($actual_salary_total); ?></td><td colspan="7"></td><td><?php echo make_comma($leave_amnt_total); ?></td><td><?php  echo make_comma($nowork_amnt_total); ?></td><td><?php echo make_comma($atn_bon_total); ?></td><td><?php  //echo make_comma($holi_amnt_total); ?></td><td><?php //echo make_comma($govt_holi_amnt_total); ?></td><td><?php //echo make_comma($produc_amnt_total); ?></td><td><?php //echo make_comma($produc_amnt_total); ?></td><td><?php echo make_comma($ot_amnt_total); ?></td><td><?php echo make_comma($produc_amnt_total); ?></td><td><?php echo make_comma($produc_bonus_total); ?></td><td><?php echo $total_v_all; ?></td><td><?php echo $advance_total; ?></td><td><?php echo make_comma($net_pay_total); ?></td><td></td>
 </tr>
 
 
 <tr style="font-weight:bold;">
 	<td colspan="33" align="left"><?php
