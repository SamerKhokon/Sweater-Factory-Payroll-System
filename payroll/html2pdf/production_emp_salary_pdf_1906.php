...
<table border="0" cellpadding="0" cellspacing="0" align="center"  class="details"> 
    <thead>
    	<tr>
        	<th colspan="9"><b>Section:<?php echo  getSectionName($section_id) ?></b></th><th colspan="10"></th><th colspan="9"><b>Line:<?php echo getBlockName($block_id,$section_id); ?></b></th><th colspan="3">Page Number:&nbsp;[[page_cu]]/[[page_nb]]</th>
        </tr>
        <tr>
...
//to_char(b.MONTH_YEAR,'mm/yyyy')='$month_year'	
	...
	b.WORKS_DAY,b.TOTAL_ATTEND,b.LEAVE,b.LATE_PRESENT,b.LUNCH_OUT,b.OT,b.HOLY_DAY,b.ADVANCE,a.GROSS,a.HOUSE_RENT,a.MEDICAL,b.CASUAL,b.SICK,a.BLOCK_ID,a.GRADE,b.GOVT_HOLI,b.EXTRA_OT,b.OTHER_AMNT,cast(substr(a.CARD_ID,2,9) as number) as pp  
	...
	
	{
				...
				$govt_holi_amnt		=round(fn_govholiamnt($gov_holiday,$basic,$total_w_day));
				...
				$leave_amnt			=round(fn_holiamnt($leave,$basic,$total_w_day));
...
try
{
	$html2pdf = new HTML2PDF('L', 'Legal', 'fr',array(1, 10, 0,0));
