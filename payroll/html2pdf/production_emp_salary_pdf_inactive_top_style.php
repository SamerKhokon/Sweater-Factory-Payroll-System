...
<tr>
    	<td style="width:260px;"><?php //echo 'Left Side Left Side' ; ?></td><td><?php echo tbl_header_fun1($dateid,$dateidT,$str); ?></td><td align="right">&nbsp;</td>
    </tr>
</table>
</div>
	...
	*/
	...
	
	{
				...
				*/
				...
				$actual_produc_chk	=($produc_amnt['production_amnt']+$produc_bonus+$fest_v+$actual_ot_amnt+$atn_bon+$leave_amnt+$govt_holi_amnt+$other_amnt+$food_amnt+$amount_cv);
				...
				*/
				...
				if($actual_produc_chk<$basic_gain)
					$actual_total_v		=round($basic_gain+$food_amnt+$amount_cv);
				else
...
try
{
	$html2pdf = new HTML2PDF('L', 'Legal', 'en',true,'UTF-8',array(0, 0, 0,0));
