...
<table border="1" cellpadding="0" cellspacing="0" align="center" class="btable">
	...
	<tbody>
<?php
//where to_char(ORDER_DATE,'mm/dd/yyyy')='$year_date'

$mtd="";
$sql="select a.ID,a.BUYER_NAME,a.MERCH_NAME,a.QUENTITY,a.ORDER_QTY,a.UNIT_PRICE,a.SHIPMENT_DATE,a.SHIP_STATUS,GAUGE,ORDER_QTY,STYLE_NAME,MACHINE_QTY,(select STYLE_ID from TBL_PAY_EMP_PRODUCTION where STYLE_ID=a.ID and ROWNUM<2) as style_id from TBL_PAY_STYLE_INFO a";
