...
$sql	="select  count(CARD_ID) from TBL_PAY_EMP_ATTEN_INFO where SECTION_ID=$section_id and COMPANY_ID=$company_id and to_date(to_char(MONTH_YEAR,'mm/yyyy'),'mm/YYYY')=to_date('".$month_year."','mm/YYYY') and  CARD_ID='$card_no'";
