...
$(document).ready(function (){
	...
	*/
	...
	$("#style").unbind('.autocomplete').autocomplete("includes/emp_production_issue_info/get_style.php?year="+year, {
					 cacheLength: 1,
					 selectFirst: true
				});
	});
		...
		<table class="form">
            ...
            <table>
                <tr>
                    ...
                    <td><div id="block_id">
                    <select name="block_id" style="width:100px;">
                        <option value="0">None</option>
                    </select>
                    </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" id="date-picker" class="error" value="<?php echo date('m/d/Y'); ?>" size="12" /></td>
                    <td colspan="2"></td>
                </tr>
            </table>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" id="quantity" class="error" /><span class="error"></span></td>
                </tr>
                <tr>
                	<td colspan="4">&nbsp;</td>
                </tr>
