...
if($row = oci_fetch_array($stid, OCI_BOTH+OCI_RETURN_NULLS)) 
{
	...
	$sql	="update TBL_PAY_EMP_ATTEN_INFO set TOTAL_ATTEND='$atten',LATE_PRESENT='$l_present',LEAVE='$leave',OT='$ot',ADVANCE='$advanced',LUNCH_OUT='$lunch_out',CASUAL='$casual',ANUAL='$annual',SICK='$sick',GOVT_HOLI='$govt_holi',OTHER_AMNT='$other_amnt'   where ID='".$row[0]."'";
