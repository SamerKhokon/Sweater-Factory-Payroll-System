...
function get_basic(gross)
{
	...
	if(section_id!=0)
	{
		var datastr	='gross='+gross+'&section_id='+section_id;
		$.ajax({
			type	:'post',
                ...
                <div class="block" id="block">
                    ...
                    <table class="form">
                        <tr>
                            ...
                            <td>
                                <select id="section_id" name="section_id" onchange="get_block(this.value)">
                        ...
                        <tr>
                               ...
                               <td><input type="text" id="empID"  class="success" /><span class="success">Enter The RF Card number.</span></td>
