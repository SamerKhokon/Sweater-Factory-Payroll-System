...
$(document).ready(function(){
   ...
   $('#btn_search').click(function(){
		...
		var uurl	='html2pdf/fixed_emp_salary_pdf.php?dateid='+dateid+'&section_id='+section_id+'&dateidT='+dateidT+'&block_id='+block_id;		 
	...
	$('#btn_paysleep').click(function(){
		...
		var dateidT		=$('#dateT').val();
		var block_id	=$('#block_id').val();
		var uurl	='html2pdf/fixed_emp_paysleep_pdf.php?dateid='+dateid+'&section_id='+section_id+'&dateidT='+dateidT+'&block_id='+block_id;		 
		if (window.showModalDialog)
		{
			window.showModalDialog(uurl,"mywindow","dialogWidth:1024px;dialogHeight:768px");
	...
	$('#btn_salary_eot').click(function(){
		...
		var dateidT		=$('#dateT').val();
		var block_id	=$('#block_id').val();
		var uurl	='html2pdf/fixed_emp_salary_eot_pdf.php?dateid='+dateid+'&section_id='+section_id+'&dateidT='+dateidT+'&block_id='+block_id;		 
		if (window.showModalDialog)
		{
			window.showModalDialog(uurl,"mywindow","dialogWidth:1024px;dialogHeight:768px");
	...
	$('#btn_paysleep_eot').click(function(){
		...
		var dateidT		=$('#dateT').val();
		var block_id	=$('#block_id').val();
		var uurl	='html2pdf/fixed_emp_paysleep_eot_pdf.php?dateid='+dateid+'&section_id='+section_id+'&dateidT='+dateidT+'&block_id='+block_id;		 
		if (window.showModalDialog)
		{
			window.showModalDialog(uurl,"mywindow","dialogWidth:1024px;dialogHeight:768px");
