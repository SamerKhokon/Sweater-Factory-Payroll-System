...
function gross_salary($sec_id,$basic)
{
	...
	$sql	="select ALLOWENCE_AMOUNT,ALLOWENCE_AFFECT from TBL_PAY_SECTION_ALLOWENCE_INFO where ALLOWENCE_HEAD_ID='166' and COMPANY_ID='".$company_id."' and SECTION_ID='$sec_id'";
		...
		if($row = mysqli_fetch_array($qstr))
		{
			$type 		= $row[1];
			$amount_tp 	= $row[0];
...
function section_pay($total_emp,$company_id,$section_id,$block_id,$actual_salary_total,$atn_bon_total,$ot_amnt_total,$produc_amnt_total,$advance_total,$net_pay_total,$produc_bonus_total,$dateid,$leave_amnt_total,$govt_holi_amnt_total,$gross_amnt_total,$other_amnt_all,$nowork_amnt_total)
{
	global $conn;
	global $company_id;
	...
	if($pyres==0)
	{
		//insert
		$mf =0;
		$sql2="insert into TBL_PAY_SECTION_PAY(SECTION_ID,COMPANY_ID,BLOCK_ID,GROSS_TOTAL,ATN_BON_TOTAL,OT_AMNT_TOTAL,PRO_AMNT_TOTAL,PRO_BON_TOTAL,ADVANCE_TOTAL,NET_PAY_TOTAL,EMP_TOTAL,MONTH_YEAR,LEAVE_AMNT,FEST_AMNT,GROSS_PAY,OTHER_AMNT,nowork_amnt) values($section_id,$company_id,'".$block_id."',$actual_salary_total,$atn_bon_total,$ot_amnt_total,$produc_amnt_total,$produc_bonus_total,$advance_total,$net_pay_total,$total_emp,to_date('$dateid','mm/dd/yyyy'),$leave_amnt_total,$govt_holi_amnt_total,$gross_amnt_total,$other_amnt_all,$nowork_amnt_total)";
...
return $tbl_h	='<table border="0" cellpadding="0" cellspacing="0" width="70%"  align="center" class="head" style="font-family:Arial; font-size:16px;">
	<tr>
	 ...
	 <tr>
       <td align="center"><b>'.$com_name.'</b></td>
     </tr>
     <tr>
     	<td align="center">'.$com_add.'</td>
     </tr>
     ...
     <tr>
     	<td align="center">Month Of '.getMonth($get_mn).'-'.$get_m[2].'</td>
     </tr>
</table>';
...
return $tbl_h	='<table border="0" cellpadding="0" cellspacing="0" width="100%"  align="center" class="head">
	<tr style="font-family:Arial; font-size:14px;">
      	<td valign="left" style="width:220px;"></td><td align="center">'.$com_name.'</td><td align="right"></td>
    </tr>
