    ...
    <!-- /TinyMCE -->
           <div class="grid_10">
            <div class="box round first fullpage">
                <h2>Add New Employee of production</h2>
                <div class="block" id="block">
                    ...
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="gross" class="error" /><span class="error">This is a required field.</span></td>
                        </tr>
					   <tr>
						...
						<tr>
                            ...
                            <td><input type="text" id="date-picker" class="error"/><span class="error">&nbsp;mm/dd/yyyy</span></td>
