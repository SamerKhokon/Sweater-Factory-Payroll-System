...
$(document).ready(function(){
   ...
   $('#btn_search').click(function(){
		...
		//alert(section_id);block_id		  
		var uurl	='html2pdf/production_rate_report2.php?dateid='+dateid+'&section_id='+section_id+'&dateto='+dateto+'&block_id='+block_id;		 
    ...
    <div class="box round first fullpage">
        ...
        <div class="block" id="block">
            <table class="form">
                ...
                <label>
                            Section</label></td>
         <td width="427"><select id="section_id" name="section_id" onchange="get_block(this.value)" style="width:150px;">
                  ...
                  <td width="97"><label>Block/Line</label></td>
                  <td width="150" colspan="2"><select id="block_id" name="block_id" style="width:150px;"><option value="0">None</option></select></td>
              </tr>
              <tr>
                ...
                <tr>
                    <td colspan="4" align="right"><input type="button" name="btn_search" id="btn_search" value=" &nbsp;&nbsp;Search&nbsp;&nbsp;" class="btn btn-navy" /></td>
                </tr>
            </table>
        </div>
    </div>
