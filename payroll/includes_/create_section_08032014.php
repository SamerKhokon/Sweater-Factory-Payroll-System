...
<?php    
    ...
    while($last_row = oci_fetch_array($section_stm,OCI_BOTH)){	
				...
				<legend>Allowences</legend>
					<table class="form"  id="dynamic_data_table">
					  <?php  
						...
						$dynamic_form_stm = oci_parse($conn,$dynamic_form_str);
						oci_execute($dynamic_form_stm); 
						while($rs = oci_fetch_array($dynamic_form_stm)){
