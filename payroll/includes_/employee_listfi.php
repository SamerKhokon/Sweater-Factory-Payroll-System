...
$(document).ready(function(){
   ...
   $('#btn_search').click(function(){
		...
		var uurl	='html2pdf/employee_listFpdf.php?section_id='+section_id+'&block_id='+block_id+'&status_id='+status_id;		 
...
<div class="grid_10">
    <div class="box round first fullpage">
        <h2>Fixed Salary Employee List</h2>
            ...
            <table class="form">
                <tr>
                    ...
                    <td><select id="section_id" name="section_id" onchange="get_block(this.value)" style="width:150px;">
                       ...
                       <?php
                        $sql	="select TBL_PAY_SECTION_INFO.ID,TBL_PAY_SECTION_INFO.SEC_NAME from TBL_PAY_SECTION_INFO,TBL_PAY_SECTION_TYPE where  TBL_PAY_SECTION_TYPE.CAT='F' and  TBL_PAY_SECTION_INFO.SEC_TYPE_ID=TBL_PAY_SECTION_TYPE.ID and TBL_PAY_SECTION_INFO.COMPANY_ID='$company_id'  order by TBL_PAY_SECTION_INFO.ID";
