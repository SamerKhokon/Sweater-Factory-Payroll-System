...
echo '!@#$';
$sql2	="select TOTAL_ATTEND,LATE_PRESENT,OT,ADVANCE,LEAVE,LUNCH_OUT,GOVT_HOLI,CASUAL,ANUAL,SICK,ID,HOLY_DAY,OTHER_AMNT from TBL_PAY_EMP_ATTEN_INFO where CARD_ID='$card_no' and SECTION_ID=$section_id	and COMPANY_ID=$company_id and to_char(MONTH_YEAR,'mm/yyyy')='$month_year'";
