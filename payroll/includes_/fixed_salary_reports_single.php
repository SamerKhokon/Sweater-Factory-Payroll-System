...
$(document).ready(function(){
   ...
   $('#btn_search').click(function(){
		...
		var uurl	='html2pdf/fixed_emp_salary_pdf_single.php?dateid='+dateid+'&section_id='+section_id+'&dateidT='+dateidT+'&block_id='+block_id+'&card_id='+card_id;		 
	...
	$('#btn_paysleep').click(function(){
		...
		var uurl	='html2pdf/fixed_emp_paysleep_pdf_single.php?dateid='+dateid+'&section_id='+section_id+'&dateidT='+dateidT+'&block_id='+block_id+'&card_id='+card_id;		 
		if (window.showModalDialog)
		{
			window.showModalDialog(uurl,"mywindow","dialogWidth:1024px;dialogHeight:768px");
	...
	//buyer
	 $('#btn_salary_buyer').click(function(){
		...
		var dateidT		=$('#dateT').val();
		var block_id	=$('#block_id').val();
		var uurl	='html2pdf/fixed_emp_salary_buyer_pdf.php?dateid='+dateid+'&section_id='+section_id+'&dateidT='+dateidT+'&block_id='+block_id;		 
		if (window.showModalDialog)
		{
			window.showModalDialog(uurl,"mywindow","dialogWidth:1024px;dialogHeight:768px");
	...
	$('#btn_paysleep_buyer').click(function(){
		...
		var dateidT		=$('#dateT').val();
		var block_id	=$('#block_id').val();
		var uurl	='html2pdf/fixed_emp_paysleep_buyer_pdf.php?dateid='+dateid+'&section_id='+section_id+'&dateidT='+dateidT+'&block_id='+block_id;		 
		if (window.showModalDialog)
		{
			window.showModalDialog(uurl,"mywindow","dialogWidth:1024px;dialogHeight:768px");
	...
	$('#btn_salary_eot').click(function(){
		...
		var dateidT		=$('#dateT').val();
		var block_id	=$('#block_id').val();
		var uurl	='html2pdf/fixed_emp_salary_eot_pdf_single.php?dateid='+dateid+'&section_id='+section_id+'&dateidT='+dateidT+'&block_id='+block_id;		 
		if (window.showModalDialog)
		{
			window.showModalDialog(uurl,"mywindow","dialogWidth:1024px;dialogHeight:768px");
	...
	$('#btn_paysleep_eot').click(function(){
		...
		var dateidT		=$('#dateT').val();
		var block_id	=$('#block_id').val();
		var uurl	='html2pdf/fixed_emp_paysleep_eot_pdf_single.php?dateid='+dateid+'&section_id='+section_id+'&dateidT='+dateidT+'&block_id='+block_id;		 
		if (window.showModalDialog)
		{
			window.showModalDialog(uurl,"mywindow","dialogWidth:1024px;dialogHeight:768px");
...
<div class="grid_10">
    <div class="box round first fullpage">
        <h2>Fixed Salary Reports(Single)</h2>
        <div class="block" id="block">
            <table width="754" class="form">
				<tr>
                    <td width="69"><label>Section</label></td>
					<td width="449"><select id="section_id" name="section_id" onchange="get_block(this.value)" style="width:150px;">
