...
$(document).ready(function(){
   ...
   $('#btn_search').click(function(){
		...
		var uurl	='html2pdf/monthly_issueAreceive_report.php?dateid='+dateid+'&section_id='+section_id+'&dateto='+dateto+'&card_id='+card_id+'&block_id='+block_id;		 
