...
<?php
	...
	require '../../../includes/db.php';		
	 ...
	 $str = "select * from tbl_pay_emp_profile where  COMPANY_ID=$company_id and  section_id in
			(select ID from TBL_PAY_SECTION_INFO where sec_type_id=(select id from tbl_pay_section_type where cat='$type'))";
	...
	while($res = oci_fetch_array($emp_info_str))
		...
		<tr class="gradeA">
		 ...
		 <td><?php echo $emp_id;?></td>
		  <td><a href="index.php?pagetitle=production_base_emp_info_display_edit&menu_id=22&sm_id=4&slno=<?php echo $slno;?>" class="salary_setting_edit_link" id="<?php echo $slno;?>">
