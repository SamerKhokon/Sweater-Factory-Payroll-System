...
$month_year	=substr($dateI,0,3).''.substr($dateI,6,10);
...
{
	$sql	="select * from TBL_PAY_LEAVE_INFO where CARD_ID='$card_id' and COMPANY_ID=$company_id and SECTION_ID=$section_id and to_char(MONTH_YEAR,'mm/yyyy')='$month_year'";
...
<table width="100%"   align="center" cellpadding="1" cellspacing="0" class="formtd"  style="border: 0px solid  #008cee;">
          <tr>
            <td width="25%" align="right" valign="top"><span class="style3">Sick leave</span></td>
            <td  width="75%" align="left" valign="middle">
            <input type="text" id="leave1" name="leave1" class="textfield" size="10" value="<?php echo $sick; ?>"><input type="hidden" id="leave1h" value="<?php echo $rest_sick; ?>" /></td>
    </tr>
		  <tr>
            <td width="25%" align="right" valign="top"><span class="style3">Casual leave</span></td>
            <td  width="75%" align="left" valign="middle">
            <input type="text" id="leave2" name="leave2" class="textfield" size="10" value="<?php echo $casual; ?>"><input type="hidden" id="leave2h" value="<?php echo $rest_cas; ?>" /></td>
    </tr>
          <tr>
            <td width="25%" align="right" valign="top"><span class="style3">Anual leave</span></td>
            <td  width="75%" align="left" valign="middle">
            <input type="text" id="leave3" name="leave3" class="textfield" size="10" value="<?php echo $annual; ?>"><input type="hidden" id="leave3h" value="<?php echo $rest_anl; ?>" /></td>
    </tr>
          <tr>
