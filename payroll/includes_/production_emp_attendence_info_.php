            ...
            <table width="74%" border="0"  class="form">
                ...
                <tr>
                  ...
                  <td><label>Fri/Holi Day</label></td>
                    <td><input type="text" id="friday" class="success" /></td>  
                </tr>
                <tr>
...
<hr/>
            ...
            <table width="711" border="0" class="form">
                ...
                <tr>
                    ...
                    <td><input type="text" id="advanced" class="success" /></td>
                    <td colspan="2"><input type="hidden" id="leave1val" class="success" /><input type="hidden" id="leave2val" class="success" /><input type="hidden" id="leave3val" class="success" /><input type="hidden" id="atn_tab_id" name="atn_tab_id" />
                    </td>
                </tr>
