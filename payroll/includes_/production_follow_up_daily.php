...
$(document).ready(function(){
   ...
   $('#btn_search').click(function(){
		...
		var uurl	='html2pdf/production_followup_daily_pdf.php?year_date='+year_date+'&sampleArray='+sampleArray2;
        ...
        <form name="Example">
            <table class="form">
                ...
                <?php
					...
					while($row = oci_fetch_array($stid, OCI_BOTH+OCI_RETURN_NULLS)) 
					{
					echo $row[1].'<input type="checkbox" name="a" id="'.$row[0].'" value="'.$row[0].'" onclick="enter_comment(this.value)" />&nbsp;';
					}
					*/
					?>
                ...
                <tr>
                    ...
                    <td><input type="text" id="year_date" class="error"/></td>
                    <td colspan="2"></td>
                </tr>                
                <tr>
