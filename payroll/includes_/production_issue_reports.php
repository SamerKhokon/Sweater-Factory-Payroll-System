...
$(document).ready(function(){
   ...
   $('#btn_search').click(function(){
		...
		//alert(section_id);		  
		var uurl	='html2pdf/production_issue_report.php?tdate='+tdate+'&fdate='+fdate+'&section_id='+section_id+'&card_no='+card_no+'&type_id='+type_id;		 
        ...
        <div class="block" id="block">
            <table class="form">
                <tr>
                    ...
                    <td><input type="text" id="card_no" class="error" /></td>
                </tr>
