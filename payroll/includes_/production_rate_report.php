...
$(document).ready(function(){
   ...
   $('#btn_search').click(function(){
		...
		var uurl	='html2pdf/production_report.php?dateid='+dateid+'&section_id='+section_id+'&dateto='+dateto+'&block_id='+block_id;		 
    ...
    <div class="box round first fullpage">
        ...
        <div class="block" id="block">
         ...
         <td width="427"><select id="section_id" name="section_id" onchange="get_block(this.value)" style="width:150px;">
                  ...
                  <td width="150" colspan="2"><select id="block_id" name="block_id" style="width:150px;"><option value="">None</option></select></td>
              </tr>
              <tr>
