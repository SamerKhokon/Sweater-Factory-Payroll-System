...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$("#quantity").keydown(function(event){
			if(event.keyCode == 13 )
			{
				...
				$.ajax({
					type	:'post',
					url		:'includes/rate_info/rate_info_enty.php',
					data	:datastr,
					cache	:false,
					success	:function(str)
						{
							...
							$('#msg').show();
							btn_reset();
							$("#jq_tbl").load('includes/rate_info/rate_info_data.php');
						}
	...
	$("#size").result(function(event, data2, formatted){
		...
		$('#btn_edit').live('click',function(){
			...
			$.ajax({
				type	:'POST',
				url		:'includes/rate_info/rate_info_edit.php',
				data	:datastr,
				cache	:false,
				success	:function(str)
				{
    ...
    <div class="box round first fullpage">
        ...
        <table class="form">
            ...
            <tr>
                ...
                <td><input type="text" id="rate" class="success" value="0"  /><span class="success">Add option Rate</span></td>
                <td><label>Quantity</label></td>
                <td><input type="text" id="quantity" class="success" value="0"  /><span class="success">Add option Quantity</span></td>
                <td colspan="2"><input type="hidden" id="status" /></td>
            </tr>
            <tr>
            	<td colspan="6" align="right"><input type="button" name="btn_save" id="btn_save" value=" &nbsp;&nbsp;Save&nbsp;&nbsp;" class="btn btn-navy" /><input type="button"  name="btn_reset" id="btn_reset" value=" &nbsp;&nbsp;Reset&nbsp;&nbsp;" class="btn btn-blue" onclick="btn_reset()" /></td>
            </tr>
        </table>
          </div>
